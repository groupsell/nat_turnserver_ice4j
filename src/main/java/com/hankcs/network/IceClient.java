...
public class IceClient
{
    ...
    private String[] turnServers = new String[]{"192.168.1.102:30000"};

    private String[] stunServers = new String[]{"192.168.1.102:30000"};
    ...
    static Logger log = LoggerFactory.getLogger(IceClient.class);
