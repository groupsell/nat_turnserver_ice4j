...
/**
 * Notification of tcp events. Is implemented by <tt>PseudoTcpSocketImpl</tt> to
 * expose stream functionality.
 *
 * @author Pawel Domas
 */
public interface PseudoTcpNotify {
	 ...
	 * 
	 * @param tcp
	 *            the socket that became readable
	 */
	 ...
	 * 
	 * @param tcp
	 *            the socket on which the write occurred
	 * @param buffer
