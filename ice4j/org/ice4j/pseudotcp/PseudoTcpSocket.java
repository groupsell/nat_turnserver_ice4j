...
public class PseudoTcpSocket extends Socket {
	 ...
	 * 
	 * @param convID
	 *            the conversation ID to set
	 * @throws IllegalStateException
	 *             when called on connected or closed socket
	 */
	 ...
	 * 
	 * @param option
	 *            the option to set on this socket.
	 * @see Option
	 */
	 ...
	 * 
	 * @param debugName
	 *            the name of this socket for debug messages
	 */
	...
	public boolean isConnecting() {
		...
		return currentState == PseudoTcpState.TCP_ESTABLISHED || currentState == PseudoTcpState.TCP_SYN_RECEIVED
	...
	/**
	 * Allows to set up the remote address directly. Otherwise, when using the
	 * other <tt>accept</tt> methods, the first address from which a packet is
	 * received, is considered the remote address.
	 *
	 * @param remoteAddress
	 *            the one and only remote address that will be accepted as
	 *            remote packet's source
	 * @param timeout
	 *            connection accept timeout value in milliseconds, after which
	 *            the exception will be thrown.
	 * @throws IOException
	 *             if socket is closed or timeout expires
	 */
