 ...
 * (used by a server implementation to determine the mapped address) as well as
 * the Descriptor of the NetAccessPoint that received it (In case the stack is
 * used on more than one ports/addresses).
 *
 * @author Emil Ivov
 */
