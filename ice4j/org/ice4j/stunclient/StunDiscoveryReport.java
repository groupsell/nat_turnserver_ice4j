 ...
 * contains information about the NAT Server (or firewall )this client is
 * behind, and a mapped address value (if discovered)
 *
 * @author Emil Ivov
 */
...
public class StunDiscoveryReport {
	 ...
	 * 
	 * @param stunAddress
	 *            An address that's accesible from everywhere.
	 */
	 ...
	 * only if both have the same nat type and their public addresses are equal
	 * or are both null.
	 * 
	 * @param obj
