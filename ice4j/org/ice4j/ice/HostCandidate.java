...
/**
 * <tt>HostCandidate</tt>s are obtained by binding to a specific port from an IP
 * address on the host that is running us. This includes IP addresses on
 * physical interfaces and logical ones, such as ones obtained through Virtual
 * Private Networks (VPNs), Mobile IPv6, Realm Specific IP (RSIP) etc.
 * <p>
...
public class HostCandidate extends LocalCandidate {
	 ...
	 *
	 * @param socket
	 *            the {@link DatagramSocket} that communication associated with
	 *            this <tt>Candidate</tt> will be going through.
	 ...
	 *            the transport address for the new <tt>HostCandidate</tt>.
	 * @param parentComponent
	 *            the <tt>Component</tt> that this candidate belongs to.
	 */
	public HostCandidate(TransportAddress transportAddress, Component parentComponent) {
		super(transportAddress, parentComponent, CandidateType.HOST_CANDIDATE, CandidateExtendedType.HOST_CANDIDATE,
				null);
	...
	/**
	 * {@inheritDoc} SHOULD NOT be used outside ice4j. Only exposed for use in
	 * the org.ice4j.socket package.
	 */
	@Override
