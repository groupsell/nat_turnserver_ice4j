...
/**
 * Extends {@link MergingDatagramSocket} with functionality specific to an ICE
 * {@link Component}.
 */
public class ComponentSocket extends MergingDatagramSocket implements PropertyChangeListener {
	 ...
	 */
	ComponentSocket(Component component, Logger levelDelegate) throws SocketException {
		super(levelDelegate);
