 ...
 * but use hard-coded values for data that typically aught to be generated (for
 * example: challenge, session-id and random fields).
 *
...
public class GoogleTurnSSLCandidateHarvester extends GoogleTurnCandidateHarvester {
	...
	static final byte SSL_SERVER_HANDSHAKE[] = {
			...
			0x42, (byte) 0x85, 0x45, (byte) 0xa7, 0x27, (byte) 0xa9, 0x5d, (byte) 0xa0, (byte) 0xb3, (byte) 0xc5,
			(byte) 0xe7, 0x53, (byte) 0xda, 0x48, 0x2b, 0x3f, (byte) 0xc6, 0x5a, (byte) 0xca, (byte) 0x89, (byte) 0xc1,
			0x58, 0x52, (byte) 0xa1, 0x78, 0x3c, 0x5b, 0x17, 0x46, 0x00, (byte) 0x85, 0x3f,

			// Session-ID length: 32
			0x20,

			// Session-ID
			0x0e, (byte) 0xd3, 0x06, 0x72, 0x5b, 0x5b, 0x1b, 0x5f, 0x15, (byte) 0xac, 0x13, (byte) 0xf9, (byte) 0x88,
			0x53, (byte) 0x9d, (byte) 0x9b, (byte) 0xe8, 0x3d, 0x7b, 0x0c, 0x30, 0x32, 0x6e, 0x38, 0x4d, (byte) 0xa2,
			0x75, 0x57, 0x41, 0x6c, 0x34, 0x5c,
	...
	public static final byte SSL_CLIENT_HANDSHAKE[] = {
			...
			// Challenge
			0x1f, 0x17, 0x0c, (byte) 0xa6, 0x2f, 0x00, 0x78, (byte) 0xfc, 0x46, 0x55, 0x2e, (byte) 0xb1, (byte) 0x83,
	 ...
	 *
	 * @param turnServer
	 *            the <tt>TransportAddress</tt> of the TURN server the new
	 *            instance is to work with
	 */
	...
	/**
	 * Initializes a new <tt>GoogleTurnSSLCandidateHarvester</tt> instance which
	 * is to work with a specific TURN server using a specific username for the
	 ...
	 *            server.
	 */
	public GoogleTurnSSLCandidateHarvester(TransportAddress turnServer, String shortTermCredentialUsername,
			String password) {
	 ...
	 *            performed by the new <tt>TurnCandidateHarvest</tt> instance
	 ...
	 *
	 * @param inputStream
	 *            <tt>InputStream</tt> of the socket
	 * @param outputStream
	 *            <tt>OutputStream</tt> of the socket
