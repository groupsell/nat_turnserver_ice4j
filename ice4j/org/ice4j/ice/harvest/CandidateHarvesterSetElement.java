...
class CandidateHarvesterSetElement {
	...
	/**
	 * Initializes a new <tt>CandidateHarvesterSetElement</tt> instance which is
	 * to represent a specific <tt>CandidateHarvester</tt> as an element in a
	 * <tt>CandidateHarvesterSet</tt>.
	 *
	 * @param harvester
	 *            the <tt>CandidateHarvester</tt> which is to be represented as
	 *            an element in a <tt>CandidateHarvesterSet</tt> by the new
	 *            instance
	 */
	 ...
	 *
	 * @param component
	 *            the <tt>Component</tt> to gather candidates for
	 * @param trickleCallback
	 *            the {@link TrickleCallback} that we will be feeding candidates
	 *            to, or <tt>null</tt> in case the application doesn't want us
	 *            trickling any candidates
	 */
	public void harvest(Component component, TrickleCallback trickleCallback) {
		...
		/*
		 * If the CandidateHarvester has not gathered any candidates, it is
		 * considered failed and will not be used again in order to not risk it
		 * slowing down the overall harvesting.
		 */
	 ...
	 *
	 * @param harvester
	 *            the <tt>CandidateHarvester</tt> to be compared to the
	 *            associated <tt>CandidateHarvester</tt>
	 * @return <tt>true</tt> if the associated <tt>CandidateHarvester</tt> is
	 *         considered to be the same as the specified <tt>harvester</tt>;
	 ...
	 * associated <tt>CandidateHarvester</tt>.
	 *
	 * @return <tt>true</tt> if <tt>CandidateHarvester#harvest(Component)</tt>
	 *         is to be called on the associated <tt>CandidateHarvester</tt>;
	 *         otherwise, <tt>false</tt>
	 */
	 ...
	 * @param enabled
	 *            <tt>true</tt> if
	 *            <tt>CandidateHarvester#harvest(Component)</tt> is to be called
	 *            on the associated <tt>CandidateHarvester</tt>; otherwise,
	 *            <tt>false</tt>
	 */
	 ...
	 *
	 * @param harvest
	 *            the harvest that we just concluded.
	 */
