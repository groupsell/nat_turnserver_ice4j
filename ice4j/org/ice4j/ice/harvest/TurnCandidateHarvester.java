...
public class TurnCandidateHarvester extends StunCandidateHarvester {
	 ...
	 *            the <tt>LongTermCredential</tt> to use with the specified
	 *            <tt>turnServer</tt> or <tt>null</tt> if the use of the
	 *            long-term credential mechanism is not determined at the time
	 *            of the initialization of the new
	 *            <tt>TurnCandidateHarvester</tt> instance
	 */
	 ...
	 *            <tt>TurnCandidateHarvester</tt> in which <tt>harvest</tt> will
	 ...
	 *         specified <tt>realm</tt> of the TURN server associated with this
