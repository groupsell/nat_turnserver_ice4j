...
public class CandidateHarvesterSet extends AbstractSet<CandidateHarvester> {
	 ...
	 *
	 * @param harvester
	 *            the <tt>CandidateHarvester</tt> to be added to this
	 ...
	 *
	 * @param component
	 *            the <tt>Component</tt> to gather candidate addresses for
	 ...
	 *
	 * @param harvesters
	 *            the <tt>CandidateHarvester</tt>s to gather candidate addresses
	 *            for the specified <tt>Component</tt>
	 * @param components
	 *            the <tt>Component</tt>s to gather candidate addresses for.
	 * @param executorService
	 *            the <tt>ExecutorService</tt> to schedule the execution of the
	 *            gathering of candidate addresses performed by the specified
	 *            <tt>harvesters</tt>
	 * @param trickleCallback
	 *            the {@link TrickleCallback} that we will be feeding candidates
	 *            to, or <tt>null</tt> in case the application doesn't want us
		...
		while (taskIter.hasNext()) {
			...
			do {
				try {
					 ...
					 */
					logger.info("disabling harvester " + harvester.getHarvester() + " due to ExecutionException: "
	...
	public Iterator<CandidateHarvester> iterator() {
		...
		return new Iterator<CandidateHarvester>() {
			...
			/**
			 * Removes from the underlying <tt>CandidateHarvesterSet</tt> the
			 * last <tt>CandidateHarvester</tt> (element) returned by this
			 * <tt>Iterator</tt>. <tt>CandidateHarvestSet</tt> does not
