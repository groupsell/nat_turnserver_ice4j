...
public class CandidateAttribute extends AttributeField {
	...
	public NameValue getAttribute() {
		...
		// NameValue pair of the method getAttribute() should return the value
		// of
		// the method getValue() of AttributeField then. Unfortunately,
		// NameValue
		// accesses its field value in multiple places so it is not a question
		// of
	 ...
	 *             if there's a problem with the <tt>value
	 * String</tt>.
	 */
