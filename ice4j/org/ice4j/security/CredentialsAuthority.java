...
/**
 * The {@link CredentialsAuthority} interface is implemented by applications in
 * order to allow the stack to verify the integrity of incoming messages
...
public interface CredentialsAuthority {
	 ...
	 *         remote user name recognized by this
