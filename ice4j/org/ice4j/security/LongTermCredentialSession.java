...
public class LongTermCredentialSession implements CredentialsAuthority {
	...
	/**
	 * Initializes a new <tt>LongTermCredentialSession</tt> instance which is to
	 * represent a use of a specific <tt>LongTermCredential</tt> in a specific
	 * realm.
	 *
	 * @param longTermCredential
	 *            the <tt>LongTermCredential</tt> a use of which is to be
	 *            represented by the new instance
	 * @param realm
	 *            the realm in which the specified <tt>LongTermCredential</tt>
	 *            is to be used
	 */
	 ...
	 *
	 * @param request
	 *            the <tt>Request</tt> in which the <tt>Attribute</tt>
	 *            supporting the STUN long-term credential mechanism are to be
	 *            added
	 ...
	 *
	 * @param username
	 *            the local user name or user frag whose credentials we'd like
	 *            to obtain
	 * @return the key (password) that corresponds to the specified local
	 *         username or user frag, an empty array if there was no password
	 *         for that username or <tt>null</tt> if the username is not a local
	 *         user name recognized by this <tt>CredentialsAuthority</tt>
	 ...
	 *         use of the <tt>LongTermCredential</tt> represented by this
	 *         instance
	 */
	 ...
	 *
	 * @param username
	 *            the remote user name or user frag whose credentials we'd like
	 *            to obtain
	 * @param media
	 *            not used
	 * @return the key (password) that corresponds to the specified remote
	 *         username or user frag, an empty array if there was no password
	 *         for that username or <tt>null</tt> if the username is not a
	 *         remote user name recognized by this <tt>CredentialsAuthority</tt>
	 ...
	 *
	 * @param nonce
	 *            the value of the NONCE attribute to be associated with the use
	 *            of the <tt>LongTermCredential</tt> represented by this
	 *            instance
	 */
	 ...
	 *
	 * @param username
	 *            the username to compare for equality to the username of the
	 *            <tt>LongTermCredential</tt> used by this instance
	 * @return <tt>true</tt> if the specified <tt>username</tt> is equal to the
	 *         username of the <tt>LongTermCredential</tt> used by this
