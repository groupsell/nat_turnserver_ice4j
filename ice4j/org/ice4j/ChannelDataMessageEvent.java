...
public class ChannelDataMessageEvent extends EventObject {
	 ...
	 * @param remoteAddress
	 *            the <tt>TransportAddress</tt> which is to be reported as the
	 *            source of the new event.
	 * @param localAddress
	 *            the <tt>TransportAddress</tt> which is to be reported as the
	 *            receiving location of the new event.
	 * @param channelDataMessage
	 *            the ChannelData <tt>Message</tt> associated with the new
	 *            event.
	 */
	public ChannelDataMessageEvent(StunStack stunStack, TransportAddress remoteAddress, TransportAddress localAddress,
