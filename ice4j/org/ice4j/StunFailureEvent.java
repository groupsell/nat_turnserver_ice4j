...
/**
 * The class is used to dispatch events that occur when a STUN transaction fails
 * asynchronously for reasons like a port unreachable exception for example.
 *
 * @author Emil Ivov
 */
public class StunFailureEvent extends BaseStunMessageEvent {
	 ...
	 *            the message itself
	 * @param localAddress
	 *            the local address that the message was sent from.
	 * @param cause
	 *            the <tt>Exception</tt> that caused this failure or
	 *            <tt>null</tt> if there's no <tt>Exception</tt> associated with
	 *            this failure
	 */
