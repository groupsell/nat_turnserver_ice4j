...
/**
 * The ChannelData message are used in TURN protocol after a client has bound a
 * channel to a peer.
 *
...
public class ChannelData {
	 ...
	 *
	 * @param channelNumber
	 *            the channel number to be checked for being in the valid
	 *            channel number range defined by the TURN RFC
	 ...
	 * @throws StunException
	 *             ILLEGAL_ARGUMENT if one or more of the arguments have invalid
	 *             values.
	 * @deprecated
	 */
