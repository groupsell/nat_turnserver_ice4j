...
public class RtcpDemuxPacketFilter implements DatagramPacketFilter {
	 ...
	 *
	 * RTP/RTCP packets are distinguished from other packets (such as STUN, DTLS
	 * or ZRTP) by the value of their first byte. See
	 * <a href="http://tools.ietf.org/html/rfc5764#section-5.1.2"> RFC5764,
	 * Section 5.1.2</a> and
	 * <a href="http://tools.ietf.org/html/rfc6189#section-5">RFC6189, Section
	 * 5</a>.
	 *
	 ...
	 * that RTP packets with Payload Types in [72, 83] (which should not appear,
	 * because these PTs are reserved or unassigned by IANA, see <a href=
	 * "http://www.iana.org/assignments/rtp-parameters/rtp-parameters.xhtml">
	 * IANA RTP Parameters</a>) with the M-bit set will be misidentified as RTCP
	 * packets.
	 * 
	 ...
	 *
	 * @param p
	 *            the <tt>DatagramPacket</tt> whose protocol we'd like to
	 *            determine.
	 ...
	 * accept <tt>p</tt>, that is, if <tt>p</tt> looks like an RTCP packet. See
	 * {@link #isRtcpPacket(java.net.DatagramPacket)}
	 * 
