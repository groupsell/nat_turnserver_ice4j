 ...
 */
class MuxingServerSocket extends DelegatingServerSocket {
	/**
	 ...
	 *
	 * @param delegate
	 *            the {@code ServerSocket} the new instance is to delegate (its
	 *            method calls) to. Technically, it is the {@code socket} of the
	 *            {@code delegate} of {@code channel}.
	 * @param channel
	 *            the {@code MuxingServerSocketChannel} associated with the new
	 *            instance
	 * @throws IOException
	 *             if an I/O error occurs
	 */
	public MuxingServerSocket(ServerSocket delegate, MuxingServerSocketChannel channel) throws IOException {
		super(Objects.requireNonNull(delegate, "delegate"), Objects.requireNonNull(channel, "channel"));
	}
}
