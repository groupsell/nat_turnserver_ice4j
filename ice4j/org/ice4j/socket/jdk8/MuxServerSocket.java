 ...
 */
class MuxServerSocket extends DelegatingServerSocket {
	/**
	 ...
	 *
	 * @param delegate
	 *            the {@code MuxingServerSocket} the new instance is to delegate
	 *            (its method calls) to. Technically, it is the {@code socket}
	 *            of the {@code delegate} of {@code channel}.
	 * @param channel
	 *            the {@code MuxServerSocketChannel} associated with the new
	 *            instance
	 * @throws IOException
