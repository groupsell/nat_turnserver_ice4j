...
public abstract class IceSocketWrapper {
	/**
	 * Sends a <tt>DatagramPacket</tt> from this socket It is a utility method
	 * to provide a common way to send for both UDP and TCP socket. If the
	 * underlying socket is a TCP one, it is still possible to get the
	 * <tt>OutputStream</tt> and do stuff with it.
	 *
	 *
	 * @param p
	 *            <tt>DatagramPacket</tt> to send
	 * @throws IOException
	...
	/**
	 * Receives a <tt>DatagramPacket</tt> from this socket. It is a utility
	 * method to provide a common way to receive for both UDP and TCP socket. If
	 * the underlying socket is a TCP one, it is still possible to get the
	 * <tt>InputStream</tt> and do stuff with it.
	 *
	 * @param p
