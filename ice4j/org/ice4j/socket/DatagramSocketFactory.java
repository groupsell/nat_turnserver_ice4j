 ...
 * DelegatingDatagramSocket#setDefaultDelegateFactory() it is possible for the
 * application developer to ensure their own variety of DatagramSocket is used
 * by the ice4j stack and passed back to their application when the ICE protocol
 * is completed.
 * 
...
public interface DatagramSocketFactory {
	/**
	 * Creates an unbound DatagramSocket: - i.e
	 * <tt>return new DatagramSocket((SocketAddress) null)</tt>.
	 *
