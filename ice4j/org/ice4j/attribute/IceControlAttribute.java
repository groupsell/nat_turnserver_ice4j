...
public abstract class IceControlAttribute extends Attribute {
	...
	/**
	 * Constructs an ICE-CONTROLLING or an ICE-CONTROLLED attribute depending on
	 * the value of <tt>isControlling</tt>.
	 *
	 * @param isControlling
	 *            indicates the kind of attribute we are trying to create
	 */
