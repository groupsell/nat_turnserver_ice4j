...
public class AttributeFactory {
	 ...
	 *             rfc3489.
	 */
	public static ErrorCodeAttribute createErrorCodeAttribute(byte errorClass, byte errorNumber, String reasonPhrase)
			throws StunException {
		...
		attribute.setReasonPhrase(reasonPhrase == null
				? ErrorCodeAttribute.getDefaultReasonPhrase(attribute.getErrorCode()) : reasonPhrase);
	 ...
	 *             if errorCode is not a valid error code as defined by rfc3489
	 */
	public static ErrorCodeAttribute createErrorCodeAttribute(char errorCode, String reasonPhrase)
			throws IllegalArgumentException {
		ErrorCodeAttribute attribute = new ErrorCodeAttribute();
	 ...
	 *            (password) that the {@link Attribute#encode()} method should
	 *            use when creating the content of this message.
	 *
	 * @return the newly created address attribute.
	 */
	 ...
	 * 
	 * @param family
	 *            address family value as specified in the RFC
