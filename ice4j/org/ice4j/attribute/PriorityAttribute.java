 ...
 * processing This attribute is not in the original specification of STUN It is
 * added as an extension to STUN to be used for ICE implementations
 *
...
public class PriorityAttribute extends Attribute {
	...
	/**
	 * The priority value specified in the attribute. An int should be enough to
	 * store this value, but long is used, since candidate and candidate-pair
	...
	/**
	 * Reconstructs the priority value from the given byte array and stores it
	 * in the 'long' variable
	 *
	 ...
	 *
	 * @param priority
	 *            the long variable specifying the priority value
	 *
	 * @throws IllegalArgumentException
	 *             if indicated priority value is illegal.
	 */
