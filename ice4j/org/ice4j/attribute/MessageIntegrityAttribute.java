...
public class MessageIntegrityAttribute extends Attribute implements ContentDependentAttribute {
	...
	/**
	 * The username that we should use to obtain an encryption key (password)
	 * that the {@link #encode()} method should use when creating the content of
	 * this message.
	 */
	 ...
	 * @param length
	 *            the length of the binary array. the start of this attribute.
	 */
	 ...
	 *             since {@link ContentDependentAttribute}s should be encoded
	 ...
	 *            encode this <tt>ContentDependentAttribute</tt> is being made
	 * @param content
